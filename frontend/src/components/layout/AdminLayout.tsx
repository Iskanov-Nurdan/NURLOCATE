import { BarChart3, ChevronLeft, ChevronRight, Cpu, CreditCard, Dog, LogOut, Moon, Sun, Users } from "lucide-react";
...
const links = [
  ...
  { to: "/admin/devices",       label: "Устройства",   icon: Cpu },
          ...
          {collapsed ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-white/40">Администратор</p>
              </div>
              <button
                onClick={() => logout().then(() => navigate("/login"))}
                className="text-white/40 transition-colors hover:text-white"
        ...
        <header className="flex items-center justify-between border-b border-border bg-panel px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-xl font-bold text-text">Панель управления</h1>
            </div>
          </div>
          <button
            onClick={toggle}
